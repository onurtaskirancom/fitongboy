  ...
  return (
    <div className="max-w-screen-lg mx-auto p-4 mt-16 bg-white dark:bg-zinc-900 text-gray-900 dark:text-white">
      ...
      <div className="space-y-4">
        ...
        <p>
          Sitemizde çeşitli antrenman programları, beslenme önerileri ve fitness
          hakkında detaylı makaleler bulabilirsiniz. İster yeni başlayan olun,
          ister ileri seviye bir sporcu, herkes için uygun içerikler
          sunmaktayız.
        </p>
        <p>
          Ayrıca, kişiye özel antrenman programları ve danışmanlık hizmetleri de
          sunuyoruz. İhtiyaçlarınıza ve hedeflerinize uygun bir program
